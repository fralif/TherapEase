...
public class CheckInAdapterE extends FirestorePagingAdapter<CheckInE, CheckInAdapterE.CheckInHolder> {
    ...
    public CheckInAdapterE(@NonNull FirestorePagingOptions<CheckInE> options, SwipeRefreshLayout swipeRefreshLayout) {
        super(options);
        this.mSwipeRefreshLayout = swipeRefreshLayout;
    }

    @Override
    protected void onBindViewHolder(@NonNull final CheckInHolder holder, int position, @NonNull CheckInE model) {
